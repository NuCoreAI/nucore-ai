...
def test_render_python_includes_runtime_summary_fields():
    routines = [
        {
    ...
    assert parsed == [
        (42, "Bedtime", "test", ["Left Hallway"], False, None,
         False, True, False, True, False,
         "2026-07-19T05:00:00", "2026-07-19T05:00:01", "2026-07-20T05:00:00"),
    ]


def test_render_python_defaults_missing_runtime_fields_to_none():
    routines = [{"id": 1, "name": "No Runtime Data", "comment": "", "device_names": []}]
    rendered = DedupeRoutines.render_python(routines)
    parsed = _routines_literal(rendered)

    assert parsed == [(1, "No Runtime Data", "", [], False, None, None, None, None, None, None, None, None, None)]
