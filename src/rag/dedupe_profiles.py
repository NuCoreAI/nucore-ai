...
class DedupeProfiles:
    ...
    PYTHON_LEGEND = (
        ...
        "#                              on-off shapes above. Each `commands[]` entry's\n"
        "#                              `values` array is positional against this same\n"
        "#                              order -- pass one `values` entry per tuple here,\n"
        "#                              in this exact order, never combine into `value`.\n"
